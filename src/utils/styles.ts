...
function isColorThemeKeys(prop: any, theme: AppTheme): prop is isColorThemeKeys {
    return Object.keys(theme.colors).filter((key) => key == prop).lenght > 0
}
